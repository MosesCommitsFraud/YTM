...
export default createPlugin({
  ...
  description: () => 'Change the playback quality of your music.',
  restartNeeded: false,
  config: {
    enabled: false,
  },
    ...
    ipc.handle(
      ...
      async (qualityLabels: string[], currentIndex: number) =>
        await dialog.showMessageBox(window, {
          ...
          message: 'Select the quality you want to play at.',
          detail: 'You are currently playing at: ' + qualityLabels[currentIndex],
          cancelId: -1,
        }),
    );
  },
